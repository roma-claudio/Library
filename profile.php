...
<div class='form-group'>
		...
		<input type='text' id='Città' name='Città' maxlength='20' value='".$_SESSION["Città"]."' class='form-control' required>
</div>
<div class='form-group'>
		<label for='Via'>Via</label>
		<input type='text' id='Via' name='via' maxlength='20' value='".$_SESSION["Via"]."' class='form-control' required>
</div>
<div class='form-group'>
		<label for='Provincia'>Provincia</label>
		<input type='text' id='Provincia' name='Provincia' maxlength='20' value='".$_SESSION["Provincia"]."' class='form-control' required>
</div>
<div class='form-group'>
		<label for='Stato'>Stato</label><input type='text' id='Stato' name='Stato' maxlength='20' value='".$_SESSION["Stato"]."' class='form-control' required>
</div>
<div class='form-group'>
		<label for='Data'>Data</label>
		<input type='date' id='Data' name='Data' value='".$_SESSION["Data"]."' class='form-control' required>
</div>
<div class='form-group'>
		<label for='luogo'>Luogo  di nascita</label><input type='text' id='Luogo' name='Luogo' maxlength='30' value='".$_SESSION["Luogo"]."' class='form-control' required></td>
</div>
<div>
